import{p as D,m as M,at as _,aq as N,au as F,S as H,av as B,aw as P,ax as U}from"./index-BoE7hNtp.js";import"./pixi-CL0R3DCn.js";function Y(i){const t=String(i??"");return t==="PHYS_MELEE"?"MELEE":t==="PHYS_RANGED"?"RANGED":t==="SIEGE"?"SIEGE":t==="ELEMENTAL_FIRE"?"FIRE":t==="DIVINE"?"DIVINE":t.replace(/_/g," ")}function G(i){if(!i)return"";if(i.description)return i.description;const t=[];return i.global?.description&&t.push(`Global: ${i.global.description}`),i.local?.description&&t.push(`Local: ${i.local.description}`),t.join(" ")}function K(i){if(document.getElementById("choose-hero-modal"))return;j(),D("choose-hero-bgm",M("assets/sfx/smash_bros_choose.mp3"),{loop:!1,gain:.55});const t=document.createElement("div");t.id="choose-hero-modal",t.style.cssText=`
  ...
  `;const A=o.querySelector("[data-card-expand]"),O=o.querySelector("[data-card-abilities]");return A&&O&&A.addEventListener("click",x=>{x.stopPropagation();const C=o.dataset.expanded==="1";o.dataset.expanded=C?"0":"1",A.textContent=C?`▼ TAP FOR ${s.length||0} ABILIT${s.length===1?"Y":"IES"}`:"▲ HIDE ABILITIES"}),o}export{K as showChooseHeroModal};
