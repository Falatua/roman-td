...
const ARCHETYPE: Record<string, Enemy['archetype']> = {
  ...
  UNDEAD_GIANT: 'BULKY', UNDEAD_CYCLOPS: 'BULKY',
  DREAD_UNDEAD_GIANT: 'RESISTANT', DREAD_UNDEAD_CYCLOPS: 'RESISTANT',
  BONEWING_DRAKE: 'ELITE', GRAVE_LEGION_DRAGON: 'ELITE', DREAD_UPRISING_DRAGON: 'RESISTANT',
