...
export const MERCATOR_LEGENDARY = [
  ...
  'AQUILA_TALONS','SPEAR_OF_MARS','JUPITERS_WRATH','CAPITOLINE_AEGIS',
...
// tower TYPE (the pool below picks distinct types per visit) — they just
...
export const MERCATOR_TOWER_OFFER_COUNT = 16;
