...
export const SFX = {
  ...
  comboTowerMade: () => playSample(sfx('assets/sfx/combo_tower_made.mp3'), 0.85),
  ...
  superOmegaCombo: () => playSample(sfx('assets/sfx/super_omega_combo.mp3'), 0.9),
...
const PRELOAD_SFX_PATHS = [
  ...
  'assets/sfx/combo_tower_made.mp3',
  ...
  'assets/sfx/super_omega_combo.mp3'
];
