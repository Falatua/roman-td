    ...
    return `
      ...
      ${foldSection('⚠ SURPRISE EVENTS — mid-wave ambushes', `
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ...
          ${noteCard('☠ Skeletal Uprising', 'Only fires during <b style="color:#aa66ff">undead waves</b>. A diamond of <b style="color:#aa66ff">FOUR SKULL URNS</b> erupts from the ground in the map center with a ground-crack particle and a discordant organ sting. The wave\'s spawn queue routes through them — undead emerge from the urns instead of the cave. The screen washes sickly purple. Enemies overlap your towers harmlessly (urns just rise through them; the towers stay).')}
