    ...
    return `
      ...
      ${foldSection('⚠ SURPRISE EVENTS — scheduled chaos', `
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ...
          ${noteCard('🔥 Gates of Hell (W16)', 'FOUR destructible Hell Gates rise — two flanking WP3, two flanking WP4 — and round-robin Fire Giants every ~1.5 seconds for 12 seconds (~8 giants total). Destroy gates early to cut their contribution to the rotation. <b style="color:#a060ff">Every Fire Giant kill drops a guaranteed EPIC item.</b>')}
      ...
      ${foldSection('SUPER COMBOS (5-base recipes)', `
        <div style="font-size:11px;color:#cdb98a;line-height:1.55;margin-bottom:6px">
          Three of the strongest towers in the game. <b>Triplex Acies</b> takes 5 ingredients; <b>Legion Prime + Consular Fatebinder</b> now take 3 ingredients each. Hard to assemble; extremely rewarding.
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px">
          ${noteCard('TRIPLEX ACIES (early, 30g)', 'Cleaves 2-tile radius melee. +25% atk-speed aura to towers within 3 tiles. Recipe: Milites + Hastati + Triarius + Centurion + Auxilia (all T2+).')}
          ...
          ${noteCard('CONSULAR FATEBINDER (apex, 250g)', 'Every shot strikes EVERY enemy on the map at 60% splash. TRUE damage. +30% global damage + atk speed aura. Recipe: Praefectus + Vulcan Engineer + Solar Priest (all T5+).')}
        </div>
      `)}
      ${foldSection('CROSS-COMBOS (combos-of-combos)', `
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ...
          ${noteCard('Imperium Eternum (T5 APEX, 150g)', '3 ingredients: Julius Caesar T5 + Aquilifer Titan T5 + Pontifex Maximus T4+. 3-tile TRUE-damage quake on every hit at 75%. +25% global atk speed.')}
          ${noteCard('Carthage Scourge (T5, 120g)', `Hannibal's Nightmare T5 + Nemesis Engine T5. 6-bolt volley, +300% vs bosses, AoE freeze every 6s.`)}
