    ...
    return `
      ...
      ${foldSection('⚠ SURPRISE EVENTS — scheduled chaos', `
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ...
          ${noteCard('🔥 Gates of Hell (W16)', 'Two destructible Hell Gates (300,000 HP each) rise at the middle of the path and pump out Fire Giants every 2 seconds for 20 seconds, alternating gates. Destroy the gates early to stop the flood. <b style="color:#a060ff">Every Fire Giant kill drops a guaranteed EPIC item.</b>')}
      ...
      ${foldSection('BOSS SIGNATURES', `
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ...
          ${noteCard('💀 Undead Warlords ×2 (W15)', '<b style="color:#ff5050">W15 now spawns TWO Undead Warlords.</b> After 5s: AMBUSH 8 Undead Berserkers mid-path. Each warlord triggers its own NECROMANCY at 40% HP, raising 4 Undead Celts at his position — so you can see up to 8 risen celts if both bosses crater near the threshold simultaneously. Plan a path-segregating maze or kill one warlord cleanly before the other dips low.')}
  ...
  if (tab === 'ENEMIES') {
    ...
    const surpriseSummary = `<div data-codex-row style="background:#0c0a08;border:1px solid #3a3025;padding:10px 12px;margin-bottom:10px">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px">
        ...
        ${noteCard('🔥 GATES OF HELL · W16', 'Two destructible <b style="color:#ff4422">Hell Gate</b> structures (300,000 HP each) rise at WP3 and WP4. Each pumps out a <b style="color:#ff4422">Fire Giant</b> (300,000 HP, slow + bulky) every 2s for 20s, alternating gates. Destroy the gates early to stop the flood. <b style="color:#ffd34d">Giants spawn AT WP3/WP4</b> — the first 2 checkpoints are bypassed entirely. <b style="color:#a060ff">Every Fire Giant drops a guaranteed EPIC item on kill.</b>')}
      </div>
    </div>`;
