  ...
  if (tab === 'MECHANICS') {
    return `
      ...
      ${foldSection('BOSS WAVE RULES', `
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ${noteCard('Focused Arrival', "Early bosses enter alone so you can read their signature mechanics. Summoned helpers, such as Hannibal's elephants, remain part of the fight. Late bosses arrive with their listed escorts.")}
