    ...
    return `
      ...
      ${foldSection('⚔ v2 LATE-GAME GAUNTLET (W21-30) — NEW UNITS', `
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ...
          ${noteCard('🏛 Mars Victor (DIVINE apex tower)', 'The new ultimate combo — recruit the <b>6 CHAMPIONS OF ROME</b> at Mercator (350g each: Marius, Agrippa, Agricola, Scipio, Caesar, Sulla) and combine all six → <b>MARS VICTOR</b>. 320 DPS, range 7, wide-splash DIVINE Wrath. The apex itself is never gambled or bought, only forged from the six Champions. The war-god avatar shreds the ROMAN-MYTH gauntlet.')}
        </div>
      `)}
