    ...
    return `
      ...
      ${foldSection('⚡ TIPS & TRICKS — UNCOMFORTABLE TRUTHS', `
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;font-size:11px">
          ...
          ${noteCard('MERCATOR = T5 ONLY', 'Stocks 10 random Tier 5 base towers at 250g each. Buy missing recipe pieces when they are worth a real campaign investment.')}
