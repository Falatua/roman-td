  ...
  if (tab === 'ENEMIES') {
    ...
    const surpriseSummary = `<div data-codex-row style="background:#0c0a08;border:1px solid #3a3025;padding:10px 12px;margin-bottom:10px">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px">
        ...
        ${noteCard('☠ DEATH UPRISING · W11 + W14', 'A single skull urn rises from the EXACT center tile of the map. Enemies pour from that one mass grave in bursts of four. <b style="color:#a050ff">Necromancy active</b>: killed grunts reanimate as bone variants. Floating skulls + soul columns overlay the urn.')}
