    ...
    return `
      ...
      ${foldSection('ECONOMY & VENDORS — WHERE THE GOLD GOES', `
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ...
          ${noteCard('▦ Stone Ramparts (gate + Mercator)', 'A mazing aid: <b style="color:#f0c040">20g</b> buys a straight line of <b style="color:#ffcc44">5 wall stones</b> placed in ONE click, centered on the tile you click. <b style="color:#ff7733">Hard cap: 5 purchases per campaign.</b> Flow: BUY → hit <b>PLACE</b> to arm it → press <b style="color:#ffe066">R</b> (or tap the floating ROTATE chip) to spin it — horizontal, vertical, or diagonal both ways → click an empty tile. <b style="color:#88ddff">Diagonal walls are fully solid:</b> enemies path 4-directionally and cannot squeeze through corner gaps. Placed tiles are ordinary stones — they block the path, sell back for 1g each, and towers can replace them. Build phase only; a placement that would seal Rome is refused without consuming the rampart.')}
