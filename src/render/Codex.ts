    ...
    return `
      ...
      ${foldSection('✨ AURA BUFF TILES — NINE GLOWING SPOTS ON THE MAP', `
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px">
          ...
          ${noteCard('🌊 TIDE TILE (Ocean)', '<b style="color:#26f6e2">Any tower on this ocean-edge tile slows damaged enemies by 30%</b>. The tower keeps its normal damage type, targeting, items, splash, and abilities; the tile simply adds control to enemies it actually hurts. Strong with high-rate towers, splash towers, and shoreline plans that drag enemies near the water.')}
        </div>
      `)}
