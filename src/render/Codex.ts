    ...
    return `
      ${foldSection('NEW HERE? READ THIS BEFORE ROME FALLS', `
        <div style="font-size:11.5px;color:#cdb98a;line-height:1.65;background:#0c0a08;padding:10px 14px;border-left:3px solid #d4af37">
          ...
          <ul style="margin:4px 0 0 14px;padding:0">
            ...
            <li><b style="color:#ffd34d">Mercator</b> sells real T5 towers at 250g. Use him to fill a critical recipe gap, not to trivialize the tower ladder.</li>
      ...
      ${foldSection('ECONOMY & VENDORS — WHERE THE GOLD GOES', `
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ...
          ${noteCard('Mercator (W4 / 9 / 14 / 19 / 23 / 27)', 'Traveling merchant. Stocks 4 LEGENDARY trophies at <b style="color:#f0c040">400g</b> each, 2 Rares, 2 Epics, 3 mid items, and guaranteed Truesight. His armory also carries the 6 Champions of Rome at 500g and random Tier 5 towers at <b style="color:#f0c040">250g</b>. These are campaign investments now, not impulse purchases.')}
          ...
          ${noteCard('Sell Prices', 'Selling an item refunds half its purchase cost. Rarity values are COMMON 20g, UNCOMMON 45g, RARE 100g, EPIC 210g, LEGENDARY 400g, and UNIQUE 500g.')}
      ...
      ${foldSection('⚡ TIPS & TRICKS — UNCOMFORTABLE TRUTHS', `
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;font-size:11px">
          ...
          ${noteCard('MERCATOR = T5 ONLY', 'Stocks Tier 5 towers at 250g. Buy a missing recipe piece when it is worth a real campaign investment.')}
