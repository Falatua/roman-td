      ...
      ${foldSection('📜 ROMAN MILITARY HISTORY — LATIN ETYMOLOGY GLOSSARY', `
        <div style="font-size:11px;color:#cdb98a;line-height:1.55">
          ...
          ${noteCard('EQUES', '<b style="color:#88ff88">HISTORICAL.</b> The Roman <b>eques</b> (plural <b>equites</b>) was both a social class and a gladiator type. The gladiator <i>eques</i> fought on horseback, opening the arena program with a thrown spear from the saddle, then dismounting to finish with a short sword and small round shield. The display name was changed from "Numidian Cavalry" because <b style="color:#ff5050">Numidians fought AGAINST Rome under Hannibal</b>, not for it — placing a Numidian cavalry unit on the legion roster was historically backwards. The sprite + name + ability profile now reads as a Roman Eques gladiator pressed into legion auxiliary service.')}
            ...
            ${noteCard('TURRIS', '<b style="color:#88ff88">HISTORICAL.</b> Short for <i>turris ambulatoria</i> — the mobile siege tower with archers on the parapet that Romans rolled up to enemy walls. Heavy-siege role fits the visual perfectly. <b style="color:#ff9933">2026-05-17 BUFF</b>: base DPS bumped 30 → <b>75</b> while keeping the slow 0.34/sec reload. Each bolt now lands roughly <b>220 damage</b> on a clean target — the largest single-shot in the early-game siege roster. Slow but devastating; reward for the long reload. 1.1-tile splash + every-3rd-shot knockback intact.')}
