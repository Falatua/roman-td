    ...
    return `
      ...
      ${foldSection('⚔ v2 LATE-GAME GAUNTLET (W21-30) — NEW UNITS', `
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          ...
          ${noteCard('🏛 Mars Victor (DIVINE apex tower)', 'The new ultimate combo — <b>IMPERIUM ETERNUM + LEGION PRIME → MARS VICTOR</b> (~80g). 320 DPS, range 7, wide-splash DIVINE Wrath. Recipe-only (never gambled or bought). The war-god avatar shreds the ROMAN-MYTH gauntlet.')}
        </div>
      `)}
