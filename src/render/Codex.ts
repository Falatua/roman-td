...
function renderTab(tab: string): string {
  ...
  if (tab === 'MECHANICS') {
    return `
      ...
      `, true)}
      ${foldSection('WAVE MODIFIERS (ENDLESS ONLY)', `
