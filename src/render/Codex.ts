      ...
      ${foldSection('📜 ROMAN MILITARY HISTORY — LATIN ETYMOLOGY GLOSSARY', `
        <div style="font-size:11px;color:#cdb98a;line-height:1.55">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px">
            ...
            ${noteCard('MEDICUS', '<b style="color:#88ff88">HISTORICAL.</b> The sprite shows a proper Roman <b>medicus</b> field-hospital tent — the canvas <i>valetudinarium</i> with a medic (capsarius) standing alongside carrying his wound-kit satchel. Each Roman legion had a permanent medical corps with surgeons, orderlies, and stretcher-bearers; the field tent the sprite depicts was a real fixture of every marching camp. The display name was shortened from "Auxilia Medicus" → "Medicus" once the visual was unambiguous.')}
