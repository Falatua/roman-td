...
export class RenderEngine {
  ...
  drawStatic(state: GameStateShape) {
    ...
    const waterDetail: Array<{
      ...
      {
        col: WATER_ZONE.col + 1,
        row: WATER_ZONE.row + 8,
        key: 'OCEAN_DEAD_ROMANS_FLOAT',
        terrain: 'water',
        width: GRID.TILE * 1.08,
        height: GRID.TILE * 0.67,
        alpha: 0.92,
        xOffset: 18,
        yOffset: 6,
        living: true,
      ...
      {
        col: WATER_ZONE.col + 2,
        row: WATER_ZONE.row + 9,
        key: 'OCEAN_DEAD_ROMANS_FLOAT',
        terrain: 'water',
        width: GRID.TILE * 0.86,
        height: GRID.TILE * 0.53,
        alpha: 0.86,
        xOffset: -8,
        yOffset: -2,
        living: true,
      ...
      {
        col: WATER_ZONE.col + 3,
        row: WATER_ZONE.row + 8,
        key: 'OCEAN_DEAD_ROMANS_FLOAT',
        terrain: 'water',
        width: GRID.TILE * 0.74,
        height: GRID.TILE * 0.46,
        alpha: 0.82,
        xOffset: 11,
        yOffset: 18,
        living: true,
      ...
      {
        col: WATER_ZONE.col + 5,
        row: WATER_ZONE.row + 8,
        key: 'OCEAN_DEAD_ROMANS_FLOAT',
        terrain: 'water',
        width: GRID.TILE * 0.92,
        height: GRID.TILE * 0.57,
        alpha: 0.88,
        xOffset: 8,
        yOffset: 10,
        living: true,
      ...
      },
      {
        ...
        key: 'OCEAN_DEAD_ROMANS_FLOAT',
        terrain: 'water',
        width: GRID.TILE * 0.78,
        height: GRID.TILE * 0.48,
        alpha: 0.84,
        xOffset: -12,
        yOffset: -5,
        living: true,
      ...
      },
      {
        ...
        key: 'OCEAN_DEAD_ROMANS_FLOAT',
        terrain: 'water',
        width: GRID.TILE * 0.68,
        height: GRID.TILE * 0.42,
        alpha: 0.78,
        xOffset: -4,
        yOffset: 20,
        living: true,
