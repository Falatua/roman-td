...
// Sell price = half of purchase cost for EVERY item. Shop purchases use
// their tracked price; enemy drops and free gifts fall back to the item's
// canonical rarity cost. No gift or drop may refund more than 50%, and old
// ceremonial sale-lock metadata is intentionally ignored by this policy.
