...
export function showTestYourMightModal(
  ...
  panel.innerHTML = `
    ...
    <div style="margin:14px auto 0;max-width:620px;font-size:11px;color:#cdb98a;line-height:1.5;letter-spacing:1px">
      Expect a boss-rush gauntlet with flyer pressure, heavy ground shields, all commander auras, storm surges, brief target veils, death-pact healing, checkpoint heals, ranged blocks, and brutal status resistance. This wave is rude on purpose.
    </div>
